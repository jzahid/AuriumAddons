odoo.define('website_sale.website_sale_inherit', function (require) {
    'use strict';
    ...
    publicWidget.registry.WebsiteSale = publicWidget.Widget.extend(VariantMixin, {
        ...
        _onChangeCartQuantity: function (ev) {
            ...
            var line_id = parseFloat($input.data('line-id'));
            //var productIDs = [parseInt($input.data('product-id'),10)];
            var productIDs = [parseFloat($input.data('product-id'))];
